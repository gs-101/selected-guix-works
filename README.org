...
- =adw-gtk-theme= ::
  ...
  adw[fn:18] is a theme for GTK 3 inspired on the current "Adwaita" design philosophy of GNOME, found on GTK 4. This theme enables styling by defining colors in the same way as it's done in GTK 4.
